...
public class GlHelper {
    ...
    public static void enableScissor(float x, float y, float width, float height) {
        ...
        float x1 = map(bottomLeft.x(), -1, 1, 0, Minecraft.getInstance().getWindow().getWidth());
        float y1 = map(bottomLeft.y(), -1, 1, 0, Minecraft.getInstance().getWindow().getHeight());
        float x2 = map(topRight.x(), -1, 1, 0, Minecraft.getInstance().getWindow().getWidth());
        float y2 = map(topRight.y(), -1, 1, 0, Minecraft.getInstance().getWindow().getHeight());
