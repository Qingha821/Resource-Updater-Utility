...
import github.qingha.gui.forms.ExceptionForm;
import github.qingha.gui.forms.GlScreenForm;
import github.qingha.gui.forms.ProgressForm;
import github.qingha.gui.forms.SelectSourceForm;
...
public class GlProgressScreen implements ProgressReceiver {
    ...
    public void printLog(String line) throws GlHelper.MinecraftStoppingException {
        ...
        ResourceSynchronizationClient.LOGGER.info(line);
        redrawScreen(true);
    }
    ...
    public void setException(Exception exception) throws GlHelper.MinecraftStoppingException {
        ...
        this.paused = true;
        ResourceSynchronizationClient.LOGGER.error("Resource Update Exception", exception);
    }

    public void shouldContinuePausing(boolean swap) throws GlHelper.MinecraftStoppingException {
    ...
    private static void drawBackground() {
        ...
        Objects.requireNonNull(Minecraft.getInstance().getTextureManager().getTexture(PRELOAD_BACKGROUND_TEXTURE)).setFilter(true, false);
        ...
        GlHelper.drawShadowString(GlHelper.getWidth() - 10 - 80, GlHelper.getHeight() - 10 - 16, 80, 20, 16,
                "v" + ResourceSynchronizationClient.MOD_VERSION, 0xffffff00, false, true);
        GlHelper.end();
