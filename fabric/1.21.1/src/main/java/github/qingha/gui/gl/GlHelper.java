...
public class GlHelper {
    ...
    public static final ResourceLocation PRELOAD_FONT_TEXTURE = ResourceLocation.parse(
            ResourceSynchronizationClient.MOD_ID + ":textures/font/harmony.png"
    );
    ...
    public static void begin(ResourceLocation texture) {
        ...
        bufferBuilder = new BufferBuilder(byteBufferBuilder, VertexFormat.Mode.QUADS, DefaultVertexFormat.POSITION_TEX_COLOR);
    ...
    public static void blit(float x1, float y1, float width, float height, float u1, float v1, float u2, float v2, int color) {
        ...
        bufferBuilder.addVertex(x1, y1, 1f)
                .setColor(color)
                .setUv(u1, v1);

        bufferBuilder.addVertex(x2, y1, 1f)
                .setColor(color)
                .setUv(u2, v1);

        bufferBuilder.addVertex(x2, y2, 1f)
                .setColor(color)
                .setUv(u2, v2);

        bufferBuilder.addVertex(x1, y2, 1f)
                .setColor(color)
                .setUv(u1, v2);
    }
    ...
    public static void blit(float x1, float y1, float width, float height, int color) {
        ...
        bufferBuilder.addVertex(x1, y1, 1f)
                .setColor(color)
                .setUv(preloadFont.whiteU, preloadFont.whiteV);
