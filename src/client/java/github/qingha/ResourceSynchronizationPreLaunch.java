...
public class ResourceSynchronizationPreLaunch implements PreLaunchEntrypoint {
    ...
    private static final String BACKGROUND_PATH = "/assets/resourcepackupdater/textures/gui/background.png";
    private static final Color PRIMARY_COLOR = new Color(63, 81, 181);  // 深蓝色
    private static final Color PRIMARY_DARK_COLOR = new Color(48, 63, 159);
    private static final Color ACCENT_COLOR = new Color(255, 64, 129);  // 粉红色
    ...
    public ResourceSynchronizationPreLaunch() {
        ...
        frame.setSize(900, 600); // 更大的窗口尺寸
        frame.setLocationRelativeTo(null);
        frame.setUndecorated(true); // 用于自定义圆角窗口
    ...
    private JButton createIconButton() {
        JButton button = new JButton("✖") {
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (getModel().isRollover()) {
                    g2.setColor(new Color(github.qingha.ResourceSynchronizationPreLaunch.PRIMARY_COLOR.getRed(), github.qingha.ResourceSynchronizationPreLaunch.PRIMARY_COLOR.getGreen(), github.qingha.ResourceSynchronizationPreLaunch.PRIMARY_COLOR.getBlue(), 30));
                    g2.fillOval(0, 0, getWidth(), getHeight());
                }

                if (getModel().isPressed()) {
                    g2.setColor(new Color(github.qingha.ResourceSynchronizationPreLaunch.PRIMARY_COLOR.getRed(), github.qingha.ResourceSynchronizationPreLaunch.PRIMARY_COLOR.getGreen(), github.qingha.ResourceSynchronizationPreLaunch.PRIMARY_COLOR.getBlue(), 60));
                    g2.fillOval(0, 0, getWidth(), getHeight());
                }

                // 绘制文本
                g2.setColor(github.qingha.ResourceSynchronizationPreLaunch.PRIMARY_COLOR);
        ...
        button.setForeground(github.qingha.ResourceSynchronizationPreLaunch.PRIMARY_COLOR);
