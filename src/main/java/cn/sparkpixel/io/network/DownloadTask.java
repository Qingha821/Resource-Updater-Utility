...
public class DownloadTask {
    ...
    public static HttpResponse<InputStream> sendHttpRequest(URI requestUri) throws IOException {
        HttpRequest httpRequest = HttpRequest.newBuilder(requestUri)
                ...
                .setHeader("User-Agent", "ResourceUpdaterUtility/" + ResourceUpdaterUtility.MOD_VERSION + " +https://www.zbx1425.cn")
                .setHeader("Accept-Encoding", "gzip")
                .GET()
                .build();
        HttpResponse<InputStream> httpResponse;
        try {
            httpResponse = ResourceUpdaterUtilityClient.HTTP_CLIENT.send(httpRequest, HttpResponse.BodyHandlers.ofInputStream());
