package cn.sparkpixel.gui;

import cn.sparkpixel.ResourceUpdaterUtility;
import cn.sparkpixel.gui.forms.ExceptionForm;
import cn.sparkpixel.gui.forms.GlScreenForm;
import cn.sparkpixel.gui.forms.ProgressForm;
import cn.sparkpixel.gui.forms.SelectSourceForm;
...
public class GlProgressScreen implements ProgressReceiver {
    ...
    public void printLog(String line) throws GlHelper.MinecraftStoppingException {
        ...
        ResourceUpdaterUtility.LOGGER.info(line);
        redrawScreen(true);
    }
    ...
    public void setException(Exception exception) throws GlHelper.MinecraftStoppingException {
        ...
        this.paused = true;
        ResourceUpdaterUtility.LOGGER.error("Resource Update Exception", exception);
    }
    ...
    public static final ResourceLocation PRELOAD_HEADER_TEXTURE =
            new ResourceLocation(ResourceUpdaterUtility.MOD_ID, "textures/gui/header.png");

    public static final ResourceLocation PRELOAD_BACKGROUND_TEXTURE =
            new ResourceLocation(ResourceUpdaterUtility.MOD_ID, "textures/gui/background.png");
    ...
    private static void drawBackground() {
        ...
        GlHelper.drawShadowString(GlHelper.getWidth() - 10 - 80, GlHelper.getHeight() - 10 - 16, 80, 20, 16,
                "v" + ResourceUpdaterUtility.MOD_VERSION, 0xffffff00, false, true);
        GlHelper.end();
